              ...
              children: [
                ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      return QuizAnswer(questions[questionIndex].options[index].optionName, questions[questionIndex].options[index].checkCorrect, correctAns(), rootContext, index, choice, tappedIndex, questions[questionIndex].options[index].optionId, questions[questionIndex].question, questions[questionIndex].quizType, questions[questionIndex].questionId);
                    })
              ],
            ),
          ),
